            ...
            options={{
              ...
              tabBarIcon: ({ focused }) =>
                focused ? (
                  <Image
                    className={"h-6 w-6"}
                    source={require("../../assets/icons/HomeFocused.png")}
                  />
                ) : (
                  <Image
                    className={"h-6 w-6"}
            ...
            options={{
              ...
              tabBarIcon: ({ focused }) =>
                focused ? (
                  <Image
                    className={"h-6 w-6"}
                    source={require("../../assets/icons/GridFocused.png")}
                  />
                ) : (
                  <Image
                    className={"h-6 w-6"}
            ...
            options={{
              ...
              tabBarIcon: ({ focused }) =>
                focused ? (
                  <Image
                    className={"h-6 w-6"}
                    source={require("../../assets/icons/ProfileFocused.png")}
                  />
                ) : (
                  <Image
                    className={"h-6 w-6"}
              ...
              {({ pressed }) => {
                return (
                  ...
                  >
                    {username ? (
                      <Image
                        className={"mt-6 h-12 w-80 rounded-lg"}
                        source={require("../../assets/icons/LoginButtonEnable.png")}
                      />
                    ) : (
                      <Image
                        className={"mt-6 h-12 w-80 rounded-lg"}
                        source={require("../../assets/icons/LoginButton.png")}
                      />
                    )}
                  </View>
                );
